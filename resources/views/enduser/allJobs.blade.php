                                ...
                                <div class="single-job-items mb-30">
                                    <div class="job-items">
                                        <div class="company-img">
                                            <a href="{{ route('job.details', ['id' => $job->id]) }}"><img src="{{ $job->image_url }}" class="img-fluid" style="width: auto; height: 90px;" alt=""></a>
                                        </div>
                                        <div class="job-tittle job-tittle2">
                                            <a href="{{ route('job.details', ['id' => $job->id]) }}">
                                                @php
                                                    $jobCategory = App\Models\JobCategory::find($job->job_category_id);
                                                @endphp
                                                <h4>
                                                    {{ $job->title }}
                                                </h4>
