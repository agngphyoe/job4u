...
<head>
    ...
    <link href="{{ asset('assets/css/main.8d288f825d8dffbbe55e.css') }}" rel="stylesheet">
...
<script type="text/javascript" src="{{ asset('assets/scripts/main.8d288f825d8dffbbe55e.js') }}">
</script>
</body>
</html>
